<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="WebApplicationTest.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="WebApplicationTest" %>
